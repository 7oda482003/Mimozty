...
const giftMessages = [
    ...
    "أنا آسف،آسف على كل ثانية زعلتك فيها مني او كنت السبب ف انك تزعلي أو تضايقي، آسف على كل لحظة كنت السبب في خنقتك وتأنيب ضميرك، آسف على كل فمتو مللي دمعة نزلت منك بسببي، آسف على كل أذى سببته ليكي،\nآسف على كل حاجه طلعت مني وكانت سبب انك حتى يتيغر مودك للأوحش بسببي",

    "ربنا يخليكي ليا 🤲",

    "انتي أجمل حاجة حصلتلي 🌿",

    "أنا مش محتاج أشوفك كل يوم عشان أحبك،\nأنا محتاجك بس عشان قلبي يفضل مطمن 🤍",

    "كل مرة بدعي فيها ربنا، بيكون اسمك حاضر في الدعاء قبل اسمي أحيانًا 🤲",

    "الناس بتدور على الراحة في أماكن كتير...\nوأنا لقيتها في فكرة إنك موجودة ❤️",

    "مفيش كلمة تقدر توصف مكانتك عندي،\nعشان أي كلمة هتبقى أقل من الحقيقة 🌿",

    "ربنا يعلم إني ما تمنيت حد في حياتي قد ما تمنيتك انتي 🥺",

    "مش عارف إزاي شخص متكلمتش معاه كتير يبقى أغلى من ناس عرفتهم سنين 🤍",

    "ما كنت يوما ممن يتبدلون ليرضوا أحدًا..\nولا ممن يهذِبون أرواحهم طمعا في عينٍ أو وعدٍ...  لكنك مررتِ فإذا بكل ما ظننته ثابتًا يعيد ترتيب نفسه..\nلا لأنكِ طلبتِ بل لأني كلما اقتربتُ منكِ التقيتُ بالرجل الذي تمنيتُ أن أكونه دائمًا🥹",

    "كل ما أفكر فيكي أتأكد إن ربنا رزقني بشعور جميل حتى لو لسه مكتملش 🌿",

    "انتي أول حد دعيت ربنا بيه من قلبي بالشكل ده 🤲",

    "في ناس بتدخل حياتنا عادي...\nوانتي دخلتي قلبي مباشرة ❤️",

    "أوقات كتير ببقى تعبان من كل حاجة،\nوفكرة إنك موجودة في الدنيا بتطمني 🥺",

    "لو خيروني بين ألف أمنية،\nهختار الأمنية اللي فيها انتي وبس 🤍",

    "كل يوم بعدي بيقربني من حلم إني أقولك: الحمد لله إنك بقيتي حلالي 🌹",

    "مش أجمل حاجة فيكي شكلك ولا كلامك...\nأجمل حاجة فيكي الأثر اللي بتسيبيه في قلبي 🌿",
